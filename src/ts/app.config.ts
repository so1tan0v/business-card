...
export const config = {
    ...
    'Programming languages': {
      ...
      leaves: {
        ...
        'Frameworks/Library': {
          ...
          leaves: {
            [`${createAnchor('Node.js', 'https://nodejs.org/', ['no-color'])}`]: {
              txt: `${createAnchor('NestJS', 'https://nestjs.com/')}, ${createAnchor('Express', 'https://expressjs.com/')}, ${createAnchor('Fastify', 'https://www.fastify.io/')}, ${createAnchor('Sequelize', 'https://sequelize.org/')}, ${createAnchor('RxJS', 'https://rxjs.dev/')}`,
              title_color: '#c4733d'
            },
  ...
  experience: [
    `
        Between <span style="color: #c4c03d">June 2018</span> and <span style="color: #c4c03d">December 2020</span> (work experience: 2 years 5 months), I worked as a technical support specialist.<br>
    ...
    `,
    `
        Between <span style="color: #c4c03d">December 2020</span> and <span style="color: #c4c03d">January 2023</span> (work experience: 2 years 2 months), I worked as a Full-stack developer.<br>
    ...
    `
        ...
        (work experience: 1 years 7 months), I worked as a Full-stack developer.<br>
